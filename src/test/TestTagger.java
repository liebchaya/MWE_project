...
//		System.out.println(Tagger.getSuffix("ישבתי"));
		...
		System.out.println(Tagger.getTaggerPOSList("ילדsdf ד"));
		System.out.println(Tagger.getTaggerPOSList("עחך ילםםם"));
		System.out.println(Tagger.getTaggerPOSList("aS שלום"));
