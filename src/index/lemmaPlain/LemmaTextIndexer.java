...
public class LemmaTextIndexer {
	...
	public enum DocField {
		ID, TERM_VECTOR, PERIOD, SOURCE, LENGTH, PLAIN
	}
	 ...
	 */
	public int index(Analyzer analyzer, LemmaTextDocReader docReader, File indexDir,
...
//						System.out.println("here");
					...
					if (fieldsToIndex.contains(DocField.PLAIN))
						doc.add(new StringField(DocField.PLAIN.name(),
								docReader.plain(), Store.YES));
	 ...
	 * @throws IndexerException
	 */
	public int index2Corpora(Analyzer analyzer, LemmaTextDocReader docReader1,
			LemmaTextDocReader docReader2, File indexDir, Set<DocField> fieldsToIndex,
