 ...
 * @author HZ
 */
public abstract class LemmaTextDocReader extends Reader 
{
	/**
	...
	/**
	 * Gets the plain text of the doc (if applicable)
	 * @return string
	 * @throws IndexerException
	 */
	public abstract String plain() throws IndexerException;
